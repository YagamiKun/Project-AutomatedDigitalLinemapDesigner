...
//-----------------------------------------------------------------------------
// Copyright 2012-2026 RenderHeads Ltd.  All rights reserved.
//-----------------------------------------------------------------------------
...
namespace RenderHeads.Media.AVProMovieCapture
{
	...
	{
		public const string ScriptVersion = "5.3.5";
#if UNITY_EDITOR_OSX || (!UNITY_EDITOR && (UNITY_STANDALONE_OSX || UNITY_IOS))
		public const string ExpectedPluginVersion = "5.3.5";
	...
	public partial class NativePlugin
	{
		...
		// Needs to match enum Transparency
		public static readonly string[] TransparencyNames = { "None", "Codec", "Top Bottom", "Left Right" };
