...
namespace RenderHeads.Media.AVProMovieCapture.Editor
{
	...
	public class CaptureFromCamera360ODSEditor : CaptureBaseEditor
	{
		...
		private SerializedProperty _propSupportWatermark;
        ...
        protected override void OnEnable()
		{
            ...
            _propSupportWatermark = serializedObject.AssertFindProperty("_settings.SupportWatermark");
        }
		...
		protected void GUI_Camera()
		{
			...
			EditorGUILayout.PropertyField(_propSupportWatermark);
        }
